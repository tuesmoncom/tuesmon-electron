...
function interceptUrls(request, callback) {
    ...
    } else if (fs.existsSync(path.join(__dirname, "tuesmon-front-dist", "dist", request.url.substring(5)))) {
      callback(path.join(__dirname, "tuesmon-front-dist", "dist", request.url.substring(5)));
    } else {
      callback(path.join(__dirname, "tuesmon-front-dist", "dist", "index.html"));
    }
}
...
function createWindow () {
  ...
  // win.loadURL("https://manage.tuesmon.com")
